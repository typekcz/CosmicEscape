...
function Game(canvas){
	...
	this.playerShip.damageTextures = get_current_player_ship_damage_textures();
...
Game.prototype = {
	...
	update: function(){
		...
		if(this.playerShip){
			...
			this.playerShip.x = Math.max(this.playerShip.x, 30);
			this.playerShip.x = Math.min(this.playerShip.x, 970);
